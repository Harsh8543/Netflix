...
//         <img className='w-60' src="https://res.cloudinary.com/admitad-gmbh/image/upload/h_0.5,f_auto/vdm6kwkmvealypmrcisi.png" alt="netflix-logo"/>
       
//        {
//         user && (
//         <div className='flex items-center'>
//         <RiDropdownList size="25px" color='white' />
//             <h1 className='text-lg font-medium text-white'>MernStack</h1>
//             <div className='ml-4'>
